...
🌐 **[Live Demo](https://ai-audit-shield.vercel.app/)**  
🐙 **[GitHub Repository](https://github.com/k-anushka14/AI-AuditShield)**  
🎬 **[Watch the 2-Minute Demo](https://youtu.be/R9CtM98bOpw?si=Auj6zY3167Ai7f-N)**
...
1. Open an AI decision case.
2. Inspect the decision context.
3. View its CooL evidence receipt.
4. Verify the evidence.
5. Simulate evidence-tampering attacks.
6. Verify the modified evidence again.
7. Investigate the resulting verification failure.
...
## STEP 17 — Add technical decisions
...
The current demo uses application-level temporary/in-memory storage rather than production-grade persistent storage.

A production deployment would require durable storage.
...
AI AuditShield does not determine whether an AI decision is correct, fair, safe, or unbiased.

It focuses on the integrity and verification of recorded evidence.
